...
Rules and builds are special value types in Lead, and the ultimate goal of what
is generated. They are not ordinary literals; they are created from `pb.rule`
definitions and rule calls.
