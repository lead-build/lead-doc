...
The examples described in the pills in this section can be found as code in the
[lead-doc](https://github.com/lead-build/lead-doc) repository, under `examples`
